...
from AnimateTemperatureClass import TemperatureAnimator
...
class main_window(QDialog):
    def __init__(self):
        ...
        self.myAnimatorClass = TemperatureAnimator # No parentheses here, this is not an Instance of the class
